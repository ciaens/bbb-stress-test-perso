...
COMPOSE_RUN_APP      = $(COMPOSE_RUN) -T app
COMPOSE_RUN_APP_NOUSER = docker-compose run --rm -T app
COMPOSE_RUN_NODE     = $(COMPOSE_RUN) -T -e HOME="/tmp" app
...
stress: ## Run stress test
	@$(COMPOSE_RUN_APP_NOUSER) ./cli.js stress -v
.PHONY: stress
